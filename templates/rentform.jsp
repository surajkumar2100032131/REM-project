...
<body>
    <h1>Property Rent Form</h1>
    
    <form action="rentform" th:object="${stud4}" method="post">
        ...
        <input type="date" id="checkInDate" name="checkInDate" class="form-input" required><br><br>
        
        <label for="checkOutDate">Check-out Date:</label>
        <input type="date" id="checkOutDate" name="checkOutDate" class="form-input" required><br><br>
