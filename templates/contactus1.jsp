...
<body>
  <div class="wrapper">
    <form class="form" action="contactus1" th:object="${stud65}" method="post">
      <div class="pageTitle title">Contact </div>
      <div class="secondaryTitle title">Please fill this form</div>
      <input type="text" class="name formEntry" id="name" name="name" placeholder="Name" />
      <input type="text" class="email formEntry" id="email" name="email"placeholder="Email"/>
      <textarea class="message formEntry" id="message" name="message"placeholder="Message"></textarea>
      ...
      <label style="color: grey" for="terms"> I Accept the <span style="color: #0e3721">Terms of Use</span> & <span style="color: #0e3721">Privacy Policy</span>.</label><br>
       <input type="submit" value="SendMessage" class="buy-button" />
